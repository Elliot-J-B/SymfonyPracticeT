...
final class CreditsControllerTest extends WebTestCase
{
    ...
    /** @var EntityRepository<Credits> $creditRepository */
    private EntityRepository $creditRepository;
    private string $path = '/credits/';

    protected function setUp(): void
    {
        $this->client = static::createClient();
        $this->manager = static::getContainer()->get('doctrine')->getManager();
        $this->creditRepository = $this->manager->getRepository(Credits::class);
    ...
    public function testNew(): void
    {
        ...
        self::assertResponseRedirects('/credits');
